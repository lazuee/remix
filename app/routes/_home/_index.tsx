...
export default function Index() {
  ...
  return (
    <div className="flex h-full items-center justify-center bg-gradient-to-b from-zinc-50 via-zinc-200 to-zinc-400 dark:from-zinc-700 dark:via-neutral-900 dark:to-zinc-900">
      <div className="flex w-full flex-col items-center justify-center gap-6 border-0 border-solid border-zinc-300 bg-zinc-50 px-8 pb-8 pt-14 dark:border-zinc-700 dark:bg-zinc-900 sm:w-[620px] sm:gap-12 sm:rounded-[2.5rem] sm:border-[1px]">
        <header className="flex flex-col items-center gap-2">
          <h1 className={`leading text-2xl font-bold text-zinc-800 dark:text-zinc-100`}>
            Welcome to <span className="sr-only">Remix</span>
          </h1>
          <div className="h-[100px] w-[301.39px] sm:h-[144px] sm:w-[434px]">
